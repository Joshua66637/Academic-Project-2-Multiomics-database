...
if(load):
    ...
    protData = "HMP_proteome_abundance.tsv"
    transcriptData = "HMP_transcriptome_abundance.tsv"
    metabolData = "HMP_metabolome_abundance.tsv"
    metabolAnno = "HMP_metabolome_annotation.csv"
